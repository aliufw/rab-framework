...
/**
 * Title:获得汉字的拼音首字母 Description: GB 2312-80 把收录的汉字分成两级。第一级汉字是常用汉字，计 3755 个， 置于
 * 16～55 区，按汉语拼音字母／笔形顺序排列；第二级汉字是次常用汉字， 计 3008 个，置于 56～87 区，按部首／笔画顺序排列，所以本程序只能查到
 * 对一级汉字的声母。同时对符合声母（zh，ch，sh）只能取首字母（z，c，s） Copyright: Copyright (c) 2009
 * Company:
 * 
...
public class ConvertLetterUtil {
	...
	public static void main(String[] args) {
		String a = ConvertLetterUtil.getFirstLetter("我是-中国人every");
