...
public class BaseRuntimeException extends RuntimeException{
	...
	public BaseRuntimeException(String code, Throwable ex) {
		super(code, ex);
		rootCause = ex;
		helper.setCode(code);
	...
	public BaseRuntimeException(String code, List<String> params) {
		super(code);
		helper.setCode(code);
	...
	public BaseRuntimeException(String code, List<String> params, Throwable ex) {
		super(code, ex);
		helper.setCode(code);
		helper.addParam(params);
		helper.parseExceptionStackInfo(ex);
	...
	public BaseRuntimeException(String code, String param, Throwable ex) {
		super(code, ex);
		helper.setCode(code);
	...
	public BaseRuntimeException(String code, String param) {
		super(code);
		helper.setCode(code);
		helper.addParam(param);
		this.exceptionMsg = helper.getContent();
